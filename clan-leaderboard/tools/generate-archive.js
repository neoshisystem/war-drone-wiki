...
function faNumber(value) { return Number(value).toLocaleString('en-US'); }
...
const cards = reports.map((report, index) => {
  ...
  const snapshot = (snapshotsFile.snapshots || []).find(item => item.source_report === sourceKey(report.page));
