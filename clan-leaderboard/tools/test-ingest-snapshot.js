...
const input = {
  snapshot: { captured_at_utc: '2026-09-15T00:00:00Z', date_persian: '24 شهریور 1405', time_iran: '03:30', type: 'delta-report', members: 1, capacity: 50, season_label: 'TEST' },
...
try {
  ...
  if (!parsed.ok || parsed.mode !== 'dry-run' || parsed.snapshot_id !== 'S06') throw new Error('unexpected ingestion result');
