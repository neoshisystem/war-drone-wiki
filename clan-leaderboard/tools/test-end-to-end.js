...
try {
  ...
  for (const file of ['players.json','snapshots.json','player-observations.json','player-observations-history.json','memberships.json','index.json']) copy(file, path.join(repoData, file), path.join(tempData, file));
  ...
  const productionFiles=[path.join(repoData,'players.json'),path.join(repoData,'snapshots.json'),path.join(repoData,'player-observations.json'),path.join(repoData,'player-observations-history.json'),path.join(repoData,'memberships.json'),path.join(repoData,'index.json')];
