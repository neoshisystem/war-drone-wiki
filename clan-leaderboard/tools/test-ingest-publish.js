...
try {
  ...
  const report = path.join(tempReports, '2026-09-18-0730.html'); if (!fs.existsSync(report)) throw new Error('PUBLISH E2E: report was not generated');
